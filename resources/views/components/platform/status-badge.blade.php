...
@php
    $theme = match ($value) {
        ...
        'cerrada', 'cerrado' => 'bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-200',
        'operativo' => 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300',
        'en_mantenimiento' => 'bg-amber-100 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300',
        'averiado' => 'bg-rose-100 text-rose-700 dark:bg-rose-950/60 dark:text-rose-300',
        'de_baja' => 'bg-slate-200 text-slate-600 dark:bg-slate-800 dark:text-slate-400',
        'vigente' => 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300',
        'por_vencer' => 'bg-amber-100 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300',
        'programado' => 'bg-sky-100 text-sky-700 dark:bg-sky-950/60 dark:text-sky-300',
        'realizado', 'reparado' => 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300',
        'asignada' => 'bg-indigo-100 text-indigo-700 dark:bg-indigo-950/60 dark:text-indigo-300',
        'reportado' => 'bg-orange-100 text-orange-700 dark:bg-orange-950/60 dark:text-orange-300',
        'en_diagnostico' => 'bg-amber-100 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300',
        'en_reparacion' => 'bg-cyan-100 text-cyan-700 dark:bg-cyan-950/60 dark:text-cyan-300',
        'activo' => 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300',
        'inactivo' => 'bg-slate-200 text-slate-600 dark:bg-slate-800 dark:text-slate-400',
